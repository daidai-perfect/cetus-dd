import{eP as b,fR as B,cE as $,g1 as S,fL as g,fH as p,cB as je,eQ as l,fI as I,fF as h,fX as C,g0 as Me,gs as lt,f$ as G,gt as ct,cx as F,fY as L,fZ as Y,g2 as xe,fG as me,fV as Xe,gu as Ye,gv as Je,gw as dt,fP as Ze,cf as we,gx as ut,gy as ht,eO as et,gz as Ae}from"./index-B1T2Y0SR.js";import{n as c,r as d,o as y}from"./class-map-CkFZhO-k.js";import{c as f,U as H}from"./index-DJ37RnOE.js";import{b as pt,e as Be,n as De}from"./ref-BHnKolnh.js";import"./vendor-4T97PGYK.js";import"./cross-BEfEbV96.js";import"./dijkstra-D_NXgYpA.js";import"./async-directive-DjbmgZnx.js";var he=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let te=class extends b{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=B.state.connectors,this.count=$.state.count,this.filteredCount=$.state.filteredWallets.length,this.isFetchingRecommendedWallets=$.state.isFetchingRecommendedWallets,this.unsubscribe.push(B.subscribeKey("connectors",e=>this.connectors=e),$.subscribeKey("count",e=>this.count=e),$.subscribeKey("filteredWallets",e=>this.filteredCount=e.length),$.subscribeKey("isFetchingRecommendedWallets",e=>this.isFetchingRecommendedWallets=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=this.connectors.find(R=>R.id==="walletConnect"),{allWallets:i}=S.state;if(!e||i==="HIDE"||i==="ONLY_MOBILE"&&!g.isMobile())return null;const o=$.state.featured.length,r=this.count+o,n=r<10?r:Math.floor(r/10)*10,s=this.filteredCount>0?this.filteredCount:n;let a=`${s}`;this.filteredCount>0?a=`${this.filteredCount}`:s<r&&(a=`${s}+`);const u=p.hasAnyConnection(je.CONNECTOR_ID.WALLET_CONNECT);return l`
      <wui-list-wallet
        name="Search Wallet"
        walletIcon="search"
        showAllWallets
...
`;var pe=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let X=class extends b{constructor(){super(),this.unsubscribe=[],this.explorerWallets=$.state.explorerWallets,this.connections=p.state.connections,this.connectorImages=Me.state.connectorImages,this.loadingTelegram=!1,this.unsubscribe.push(p.subscribeKey("connections",e=>this.connections=e),Me.subscribeKey("connectorImages",e=>this.connectorImages=e),$.subscribeKey("explorerFilteredWallets",e=>{this.explorerWallets=e!=null&&e.length?e:$.state.explorerWallets}),$.subscribeKey("explorerWallets",e=>{var i;(i=this.explorerWallets)!=null&&i.length||(this.explorerWallets=e)})),g.isTelegram()&&g.isIos()&&(this.loadingTelegram=!p.state.wcUri,this.unsubscribe.push(p.subscribeKey("wcUri",e=>this.loadingTelegram=!e)))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return l`
    ...
    `}onClickConnector(e){var o;const i=(o=h.state.data)==null?void 0:o.redirectView;if(e.subtype==="walletConnect"){B.setActiveConnector(e.connector),g.isMobile()?h.push("AllWallets"):h.push("ConnectingWalletConnect",{redirectView:i});return}if(e.subtype==="multiChain"){B.setActiveConnector(e.connector),h.push("ConnectingMultiChain",{redirectView:i});return}if(e.subtype==="injected"){B.setActiveConnector(e.connector),h.push("ConnectingExternal",{connector:e.connector,redirectView:i,wallet:e.connector.explorerWallet});return}if(e.subtype==="announced"){if(e.connector.id==="walletConnect"){g.isMobile()?h.push("AllWallets"):h.push("ConnectingWalletConnect",{redirectView:i});return}h.push("ConnectingExternal",{connector:e.connector,redirectView:i,wallet:e.connector.explorerWallet});return}h.push("ConnectingExternal",{connector:e.connector,redirectView:i})}renderWallet(e,i){const o=e.wallet,r=G.getWalletImage(o),s=p.hasAnyConnection(je.CONNECTOR_ID.WALLET_CONNECT),a=this.loadingTelegram,u=e.subtype==="recent"?"recent":void 0,R=e.subtype==="recent"?"info":void 0;return l`
      <w3m-list-wallet
        displayIndex=${i}
        imageSrc=${y(r)}
        name=${o.name??"Unknown"}
...
`;var ge=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};const mt={lg:"lg-regular",md:"md-regular",sm:"sm-regular"},gt={lg:"md",md:"sm",sm:"sm"};let ie=class extends b{constructor(){super(...arguments),this.icon="mobile",this.size="md",this.label="",this.active=!1}render(){return l`
      <button data-active=${this.active}>
        ${this.icon?l`<wui-icon size=${gt[this.size]} name=${this.icon}></wui-icon>`:""}
        <wui-text variant=${mt[this.size]}> ${this.label} </wui-text>
      </button>
    `}};ie.styles=[L,Y,wt];ge([c()],ie.prototype,"icon",void 0);ge([c()],ie.prototype,"size",void 0);ge([c()],ie.prototype,"label",void 0);ge([c({type:Boolean})],ie.prototype,"active",void 0);ie=ge([f("wui-tab-item")],ie);const bt=C`
  :host {
    display: inline-flex;
    align-items: center;
...
`;var be=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let ne=class extends b{constructor(){super(...arguments),this.tabs=[],this.onTabChange=()=>null,this.size="md",this.activeTab=0}render(){return this.dataset.size=this.size,this.tabs.map((e,i)=>{var r;const o=i===this.activeTab;return l`
        ...
        ></wui-tab-item>
      `})}onTabClick(e){this.activeTab=e,this.onTabChange(e)}};ne.styles=[L,Y,bt];be([c({type:Array})],ne.prototype,"tabs",void 0);be([c()],ne.prototype,"onTabChange",void 0);be([c()],ne.prototype,"size",void 0);be([d()],ne.prototype,"activeTab",void 0);ne=be([f("wui-tabs")],ne);var Ne=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let Ce=class extends b{constructor(){super(...arguments),this.platformTabs=[],this.unsubscribe=[],this.platforms=[],this.onSelectPlatfrom=void 0}disconnectCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=this.generateTabs();return l`
...
`;var tt=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let Re=class extends b{constructor(){super(...arguments),this.radius=36}render(){return this.svgLoaderTemplate()}svgLoaderTemplate(){const e=this.radius>50?50:this.radius,o=36-e,r=116+o,n=245+o,s=360+o*1.75;return l`
    ...
    `}};Re.styles=[L,yt];tt([c({type:Number})],Re.prototype,"radius",void 0);Re=tt([f("wui-loading-thumbnail")],Re);const $t=C`
  wui-flex {
    width: 100%;
    height: 52px;
    box-sizing: border-box;
...
`;var Oe=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let de=class extends b{constructor(){super(...arguments),this.disabled=!1,this.label="",this.buttonLabel=""}render(){return l`
    ...
    `}};de.styles=[L,Y,$t];Oe([c({type:Boolean})],de.prototype,"disabled",void 0);Oe([c()],de.prototype,"label",void 0);Oe([c()],de.prototype,"buttonLabel",void 0);de=Oe([f("wui-cta-button")],de);const vt=C`
  :host {
    display: block;
    padding: 0 ${({spacing:t})=>t[5]} ${({spacing:t})=>t[5]};
  }
`;var it=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let We=class extends b{constructor(){super(...arguments),this.wallet=void 0}render(){if(!this.wallet)return this.style.display="none",null;const{name:e,app_store:i,play_store:o,chrome_store:r,homepage:n}=this.wallet,s=g.isMobile(),a=g.isIos(),u=g.isAndroid(),R=[i,o,n,r].filter(Boolean).length>1,z=H.getTruncateString({string:e,charsStart:12,charsEnd:0,truncate:"end"});return R&&!s?l`
        <wui-cta-button
          label=${`Don't have ${z}?`}
          buttonLabel="Get"
...
`;var D=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};class _ extends b{constructor(){var e,i,o,r,n;super(),this.wallet=(e=h.state.data)==null?void 0:e.wallet,this.connector=(i=h.state.data)==null?void 0:i.connector,this.timeout=void 0,this.secondaryBtnIcon="refresh",this.onConnect=void 0,this.onRender=void 0,this.onAutoConnect=void 0,this.isWalletConnect=!0,this.unsubscribe=[],this.imageSrc=G.getConnectorImage(this.connector)??G.getWalletImage(this.wallet),this.name=((o=this.wallet)==null?void 0:o.name)??((r=this.connector)==null?void 0:r.name)??"Wallet",this.isRetrying=!1,this.uri=p.state.wcUri,this.error=p.state.wcError,this.ready=!1,this.showRetry=!1,this.label=void 0,this.secondaryBtnLabel="Try again",this.secondaryLabel="Accept connection request in the wallet",this.isLoading=!1,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(p.subscribeKey("wcUri",s=>{var a;this.uri=s,this.isRetrying&&this.onRetry&&(this.isRetrying=!1,(a=this.onConnect)==null||a.call(this))}),p.subscribeKey("wcError",s=>this.error=s)),(g.isTelegram()||g.isSafari())&&g.isIos()&&p.state.wcUri&&((n=this.onConnect)==null||n.call(this))}firstUpdated(){var e;(e=this.onAutoConnect)==null||e.call(this),this.showRetry=!this.onAutoConnect}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),p.setWcError(!1),clearTimeout(this.timeout)}render(){var o;(o=this.onRender)==null||o.call(this),this.onShowRetry();const e=this.error?"Connection can be declined if a previous request is still active":this.secondaryLabel;let i="";return this.label?i=this.label:(i=`Continue in ${this.name}`,this.error&&(i="Connection declined")),l`
    ...
    `}onShowRetry(){var e;if(this.error&&!this.showRetry){this.showRetry=!0;const i=(e=this.shadowRoot)==null?void 0:e.querySelector("wui-button");i==null||i.animate([{opacity:0},{opacity:1}],{fill:"forwards",easing:"ease"})}}onTryAgain(){var e,i;p.setWcError(!1),this.onRetry?(this.isRetrying=!0,(e=this.onRetry)==null||e.call(this)):(i=this.onConnect)==null||i.call(this)}loaderTemplate(){const e=xe.state.themeVariables["--w3m-border-radius-master"],i=e?parseInt(e.replace("px",""),10):4;return l`<wui-loading-thumbnail radius=${i*9}></wui-loading-thumbnail>`}onCopyUri(){try{this.uri&&(g.copyToClopboard(this.uri),me.showSuccess("Link copied"))}catch{me.showError("Failed to copy")}}}_.styles=xt;D([d()],_.prototype,"isRetrying",void 0);D([d()],_.prototype,"uri",void 0);D([d()],_.prototype,"error",void 0);D([d()],_.prototype,"ready",void 0);D([d()],_.prototype,"showRetry",void 0);D([d()],_.prototype,"label",void 0);D([d()],_.prototype,"secondaryBtnLabel",void 0);D([d()],_.prototype,"secondaryLabel",void 0);D([d()],_.prototype,"isLoading",void 0);D([c({type:Boolean})],_.prototype,"isMobile",void 0);D([c()],_.prototype,"onRetry",void 0);var Ct=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let Ve=class extends _{constructor(){var e;if(super(),!this.wallet)throw new Error("w3m-connecting-wc-browser: No wallet provided");this.onConnect=this.onConnectProxy.bind(this),this.onAutoConnect=this.onConnectProxy.bind(this),I.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"browser",displayIndex:(e=this.wallet)==null?void 0:e.display_index,walletRank:this.wallet.order,view:h.state.view}})}async onConnectProxy(){try{this.error=!1;const{connectors:e}=B.state,i=e.find(o=>{var r,n,s;return o.type==="ANNOUNCED"&&((r=o.info)==null?void 0:r.rdns)===((n=this.wallet)==null?void 0:n.rdns)||o.type==="INJECTED"||o.name===((s=this.wallet)==null?void 0:s.name)});if(i)await p.connectExternal(i,i.chain);else throw new Error("w3m-connecting-wc-browser: No connector found");Xe.close()}catch(e){e instanceof Ye&&e.originalName===Je.PROVIDER_RPC_ERROR_NAME.USER_REJECTED_REQUEST?I.sendEvent({type:"track",event:"USER_REJECTED",properties:{message:e.message}}):I.sendEvent({type:"track",event:"CONNECT_ERROR",properties:{message:(e==null?void 0:e.message)??"Unknown"}}),this.error=!0}}};Ve=Ct([f("w3m-connecting-wc-browser")],Ve);var Rt=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let Fe=class extends _{constructor(){var e;if(super(),!this.wallet)throw new Error("w3m-connecting-wc-desktop: No wallet provided");this.onConnect=this.onConnectProxy.bind(this),this.onRender=this.onRenderProxy.bind(this),I.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"desktop",displayIndex:(e=this.wallet)==null?void 0:e.display_index,walletRank:this.wallet.order,view:h.state.view}})}onRenderProxy(){var e;!this.ready&&this.uri&&(this.ready=!0,(e=this.onConnect)==null||e.call(this))}onConnectProxy(){var e;if((e=this.wallet)!=null&&e.desktop_link&&this.uri)try{this.error=!1;const{desktop_link:i,name:o}=this.wallet,{redirect:r,href:n}=g.formatNativeUrl(i,this.uri);p.setWcLinking({name:o,href:n}),p.setRecentWallet(this.wallet),g.openHref(r,"_blank")}catch{this.error=!0}}};Fe=Rt([f("w3m-connecting-wc-desktop")],Fe);var fe=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let oe=class extends _{constructor(){var e;if(super(),this.btnLabelTimeout=void 0,this.redirectDeeplink=void 0,this.redirectUniversalLink=void 0,this.target=void 0,this.preferUniversalLinks=S.state.experimental_preferUniversalLinks,this.isLoading=!0,this.onConnect=()=>{dt.onConnectMobile(this.wallet)},!this.wallet)throw new Error("w3m-connecting-wc-mobile: No wallet provided");this.secondaryBtnLabel="Open",this.secondaryLabel=Ze.CONNECT_LABELS.MOBILE,this.secondaryBtnIcon="externalLink",this.onHandleURI(),this.unsubscribe.push(p.subscribeKey("wcUri",()=>{this.onHandleURI()})),I.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"mobile",displayIndex:(e=this.wallet)==null?void 0:e.display_index,walletRank:this.wallet.order,view:h.state.view}})}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.btnLabelTimeout)}onHandleURI(){var e;this.isLoading=!this.uri,!this.ready&&this.uri&&(this.ready=!0,(e=this.onConnect)==null||e.call(this))}onTryAgain(){var e;p.setWcError(!1),(e=this.onConnect)==null||e.call(this)}};fe([d()],oe.prototype,"redirectDeeplink",void 0);fe([d()],oe.prototype,"redirectUniversalLink",void 0);fe([d()],oe.prototype,"target",void 0);fe([d()],oe.prototype,"preferUniversalLinks",void 0);fe([d()],oe.prototype,"isLoading",void 0);oe=fe([f("w3m-connecting-wc-mobile")],oe);const Wt=.1,He=2.5,V=7;function Le(t,e,i){return t===e?!1:(t-e<0?e-t:t-e)<=i+Wt}function _t(t,e){const i=Array.prototype.slice.call(pt.create(t,{errorCorrectionLevel:e}).modules.data,0),o=Math.sqrt(i.length);return i.reduce((r,n,s)=>(s%o===0?r.push([n]):r[r.length-1].push(n))&&r,[])}const Et={generate({uri:t,size:e,logoSize:i,padding:o=8,dotColor:r="var(--apkt-colors-black)"}){const s=[],a=_t(t,"Q"),u=(e-2*o)/a.length,R=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];R.forEach(({x:v,y:w})=>{const W=(a.length-V)*u*v+o,m=(a.length-V)*u*w+o,E=.45;for(let x=0;x<R.length;x+=1){const N=u*(V-x*2);s.push(we`
            ...
            />
          `)}});const z=Math.floor((i+25)/u),Z=a.length/2-z/2,Q=a.length/2+z/2-1,ce=[];a.forEach((v,w)=>{v.forEach((W,m)=>{if(a[w][m]&&!(w<V&&m<V||w>a.length-(V+1)&&m<V||w<V&&m>a.length-(V+1))&&!(w>Z&&w<Q&&m>Z&&m<Q)){const E=w*u+u/2+o,x=m*u+u/2+o;ce.push([E,x])}})});const ee={};return ce.forEach(([v,w])=>{var W;ee[v]?(W=ee[v])==null||W.push(w):ee[v]=[w]}),Object.entries(ee).map(([v,w])=>{const W=w.filter(m=>w.every(E=>!Le(m,E,u)));return[Number(v),W]}).forEach(([v,w])=>{w.forEach(W=>{s.push(we`<circle cx=${v} cy=${W} fill=${r} r=${u/He} />`)})}),Object.entries(ee).filter(([v,w])=>w.length>1).map(([v,w])=>{const W=w.filter(m=>w.some(E=>Le(m,E,u)));return[Number(v),W]}).map(([v,w])=>{w.sort((m,E)=>m<E?-1:1);const W=[];for(const m of w){const E=W.find(x=>x.some(N=>Le(m,N,u)));E?E.push(m):W.push([m])}return[v,W.map(m=>[m[0],m[m.length-1]])]}).forEach(([v,w])=>{w.forEach(([W,m])=>{s.push(we`
              <line
                x1=${v}
                x2=${v}
                y1=${W}
...
`;var le=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let K=class extends b{constructor(){var e;super(),this.wallet=(e=h.state.data)==null?void 0:e.wallet,this.unsubscribe=[],this.platform=void 0,this.platforms=[],this.isSiwxEnabled=!!S.state.siwx,this.remoteFeatures=S.state.remoteFeatures,this.displayBranding=!0,this.basic=!1,this.determinePlatforms(),this.initializeConnection(),this.unsubscribe.push(S.subscribeKey("remoteFeatures",i=>this.remoteFeatures=i))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return S.state.enableMobileFullScreen&&this.setAttribute("data-mobile-fullscreen","true"),l`
      ${this.headerTemplate()}
      <div class="platform-container">${this.platformTemplate()}</div>
      ${this.reownBrandingTemplate()}
    `}reownBrandingTemplate(){var e;return!((e=this.remoteFeatures)!=null&&e.reownBranding)||!this.displayBranding?null:l`<wui-ux-by-reown></wui-ux-by-reown>`}async initializeConnection(e=!1){var i,o;if(!(this.platform==="browser"||S.state.manualWCControl&&!e))try{const{wcPairingExpiry:r,status:n}=p.state,{redirectView:s}=h.state.data??{};if(e||S.state.enableEmbedded||g.isPairingExpired(r)||n==="connecting"){const a=p.getConnections(F.state.activeChain),u=(i=this.remoteFeatures)==null?void 0:i.multiWallet,R=a.length>0;await p.connectWalletConnect({cache:"never"}),this.isSiwxEnabled||(R&&u?(h.replace("ProfileWallets"),me.showSuccess("New Wallet Added")):s?h.replace(s):Xe.close())}}catch(r){if(r instanceof Error&&r.message.includes("An error occurred when attempting to switch chain")&&!S.state.enableNetworkSwitch&&F.state.activeChain){F.setActiveCaipNetwork(ut.getUnsupportedNetwork(`${F.state.activeChain}:${(o=F.state.activeCaipNetwork)==null?void 0:o.id}`)),F.showUnsupportedChainUI();return}r instanceof Ye&&r.originalName===Je.PROVIDER_RPC_ERROR_NAME.USER_REJECTED_REQUEST?I.sendEvent({type:"track",event:"USER_REJECTED",properties:{message:r.message}}):I.sendEvent({type:"track",event:"CONNECT_ERROR",properties:{message:(r==null?void 0:r.message)??"Unknown"}}),p.setWcError(!0),me.showError(r.message??"Connection error"),p.resetWcConnection(),h.goBack()}}determinePlatforms(){if(!this.wallet){this.platforms.push("qrcode"),this.platform="qrcode";return}if(this.platform)return;const{mobile_link:e,desktop_link:i,webapp_link:o,injected:r,rdns:n}=this.wallet,s=r==null?void 0:r.map(({injected_id:ee})=>ee).filter(Boolean),a=[...n?[n]:s??[]],u=S.state.isUniversalProvider?!1:a.length,R=e,z=o,Z=p.checkInstalled(a),Q=u&&Z,ce=i&&!g.isMobile();Q&&!F.state.noAdapters&&this.platforms.push("browser"),R&&this.platforms.push(g.isMobile()?"mobile":"qrcode"),z&&this.platforms.push("web"),ce&&this.platforms.push("desktop"),!Q&&u&&!F.state.noAdapters&&this.platforms.push("unsupported"),this.platform=this.platforms[0]}platformTemplate(){switch(this.platform){case"browser":return l`<w3m-connecting-wc-browser></w3m-connecting-wc-browser>`;case"web":return l`<w3m-connecting-wc-web></w3m-connecting-wc-web>`;case"desktop":return l`
    ...
    </wui-flex>`:null}};Ue([d()],Ee.prototype,"isMobile",void 0);Ue([d()],Ee.prototype,"remoteFeatures",void 0);Ee=Ue([f("w3m-connecting-wc-basic-view")],Ee);const Pt=C`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
...
`;var Pe=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let ue=class extends b{constructor(){super(...arguments),this.inputElementRef=Be(),this.checked=!1,this.disabled=!1,this.size="md"}render(){return l`
    ...
    `}dispatchChangeEvent(){var e;this.dispatchEvent(new CustomEvent("switchChange",{detail:(e=this.inputElementRef.value)==null?void 0:e.checked,bubbles:!0,composed:!0}))}};ue.styles=[L,Y,Pt];Pe([c({type:Boolean})],ue.prototype,"checked",void 0);Pe([c({type:Boolean})],ue.prototype,"disabled",void 0);Pe([c()],ue.prototype,"size",void 0);ue=Pe([f("wui-toggle")],ue);const Lt=C`
  :host {
    height: auto;
  }
...
`;var rt=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let Se=class extends b{constructor(){super(...arguments),this.checked=!1}render(){return l`
    ...
    `}handleToggleChange(e){e.stopPropagation(),this.checked=e.detail,this.dispatchSwitchEvent()}dispatchSwitchEvent(){this.dispatchEvent(new CustomEvent("certifiedSwitchChange",{detail:this.checked,bubbles:!0,composed:!0}))}};Se.styles=[L,Y,Lt];rt([c({type:Boolean})],Se.prototype,"checked",void 0);Se=rt([f("wui-certified-switch")],Se);const jt=C`
  :host {
    position: relative;
    width: 100%;
    display: inline-flex;
...
`;var j=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let k=class extends b{constructor(){super(...arguments),this.inputElementRef=Be(),this.disabled=!1,this.loading=!1,this.placeholder="",this.type="text",this.value="",this.size="md"}render(){return l` <div class="wui-input-text-container">
...
`;var A=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let T=class extends b{render(){return this.style.cssText=`
    ...
    `,l`<slot></slot>`}};T.styles=[L,Dt];A([c()],T.prototype,"gridTemplateRows",void 0);A([c()],T.prototype,"gridTemplateColumns",void 0);A([c()],T.prototype,"justifyItems",void 0);A([c()],T.prototype,"alignItems",void 0);A([c()],T.prototype,"justifyContent",void 0);A([c()],T.prototype,"alignContent",void 0);A([c()],T.prototype,"columnGap",void 0);A([c()],T.prototype,"rowGap",void 0);A([c()],T.prototype,"gap",void 0);A([c()],T.prototype,"padding",void 0);A([c()],T.prototype,"margin",void 0);T=A([f("wui-grid")],T);const Nt=C`
  button {
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`;var ve=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let ae=class extends b{constructor(){super(...arguments),this.prevQuery="",this.prevBadge=void 0,this.loading=!0,this.mobileFullScreen=S.state.enableMobileFullScreen,this.query=""}render(){return this.mobileFullScreen&&this.setAttribute("data-mobile-fullscreen","true"),this.onSearch(),this.loading?l`<wui-loading-spinner color="accent-primary"></wui-loading-spinner>`:this.walletsTemplate()}async onSearch(){(this.query.trim()!==this.prevQuery.trim()||this.badge!==this.prevBadge)&&(this.prevQuery=this.query,this.prevBadge=this.badge,this.loading=!0,await $.searchWallet({search:this.query,badge:this.badge}),this.loading=!1)}walletsTemplate(){const{search:e}=$.state,i=Ae.markWalletsAsInstalled(e),o=Ae.filterWalletsByWcSupport(i);return o.length?l`
    ...
    `:l`
      ...
      `}onConnectWallet(e){B.selectWalletConnector(e)}};ae.styles=qt;ve([d()],ae.prototype,"loading",void 0);ve([d()],ae.prototype,"mobileFullScreen",void 0);ve([c()],ae.prototype,"query",void 0);ve([c()],ae.prototype,"badge",void 0);ae=ve([f("w3m-all-wallets-search")],ae);var qe=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let Ie=class extends b{constructor(){super(...arguments),this.search="",this.badge=void 0,this.onDebouncedSearch=g.debounce(e=>{this.search=e})}render(){const e=this.search.length>=2;return l`
    ...
    `}onInputChange(e){this.onDebouncedSearch(e.detail)}onCertifiedSwitchChange(e){e.detail?(this.badge="certified",me.showSvg("Only WalletConnect certified",{icon:"walletConnectBrown",iconColor:"accent-100"})):this.badge=void 0}qrButtonTemplate(){return g.isMobile()?l`
        <wui-icon-box
          size="xl"
          iconSize="xl"
...
`;var M=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let P=class extends b{constructor(){super(...arguments),this.imageSrc="google",this.loading=!1,this.disabled=!1,this.rightIcon=!0,this.rounded=!1,this.fullSize=!1}render(){return this.dataset.rounded=this.rounded?"true":"false",l`
    ...
    `}templateLeftIcon(){return this.icon?l`<wui-image
      ...
      src=${this.imageSrc}
    ></wui-image>`}templateRightIcon(){return this.rightIcon?this.loading?l`<wui-loading-spinner size="md" color="accent-primary"></wui-loading-spinner>`:l`<wui-icon name="chevronRight" size="lg" color="default"></wui-icon>`:null}};P.styles=[L,Y,Mt];M([c()],P.prototype,"imageSrc",void 0);M([c()],P.prototype,"icon",void 0);M([c()],P.prototype,"iconColor",void 0);M([c({type:Boolean})],P.prototype,"loading",void 0);M([c()],P.prototype,"tabIdx",void 0);M([c({type:Boolean})],P.prototype,"disabled",void 0);M([c({type:Boolean})],P.prototype,"rightIcon",void 0);M([c({type:Boolean})],P.prototype,"rounded",void 0);M([c({type:Boolean})],P.prototype,"fullSize",void 0);P=M([f("wui-list-item")],P);var Vt=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let Ge=class extends b{constructor(){var e;super(...arguments),this.wallet=(e=h.state.data)==null?void 0:e.wallet}render(){if(!this.wallet)throw new Error("w3m-downloads-view");return l`
    ...
    `:null}openStore(e){e.href&&this.wallet&&(I.sendEvent({type:"track",event:"GET_WALLET",properties:{name:this.wallet.name,walletRank:this.wallet.order,explorerId:this.wallet.id,type:e.type}}),g.openHref(e.href,"_blank"))}onChromeStore(){var e;(e=this.wallet)!=null&&e.chrome_store&&this.openStore({href:this.wallet.chrome_store,type:"chrome_store"})}onAppStore(){var e;(e=this.wallet)!=null&&e.app_store&&this.openStore({href:this.wallet.app_store,type:"app_store"})}onPlayStore(){var e;(e=this.wallet)!=null&&e.play_store&&this.openStore({href:this.wallet.play_store,type:"play_store"})}onHomePage(){var e;(e=this.wallet)!=null&&e.homepage&&this.openStore({href:this.wallet.homepage,type:"homepage"})}};Ge=Vt([f("w3m-downloads-view")],Ge);export{Ie as W3mAllWalletsView,Ee as W3mConnectingWcBasicView,Ge as W3mDownloadsView};
