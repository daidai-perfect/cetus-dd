import{G as ve,B as fe,z as ge,x as be,M as g,S as se,R as l,u as v,y as P,v as f,p as a,b as K,s as ce,q as le,C as m,e as Y,d as ye,i as S,m as ie,O as E,g as q,a as oe,n as A,c as H,T as xe,w as Ce,l as ke,j as Se}from"./core-DmmGUCrF.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-DdoWz00Z.js";import"./cross-Dyvezp3y.js";import"./vendor-1PTJj1Hr.js";import"./index-CrBUY_gY.js";import"./CrossSwap-DNZLSTIG.js";import"./PriceImpact-APKimFCL.js";import"./CurrentPrice-ZDZcbBml.js";import"./Slippage-CiF-ljjH.js";import"./index-CoyKYx6g.js";import"./VaulDrawer-_kP8udcf.js";import"./useSwapHelper-ujMwdTTj.js";import"./useGetPoolList-BabBuxQH.js";import"./utils-B8b4n7cp.js";import"./useWrapPoolData-C_Gr5X_b.js";import"./sui-priority-DUxcZQQg.js";import"./usePreviousValue-BS6eqUGQ.js";import"./isWalletInstalled-BxdZT5Hc.js";import"./HighlightText-Dg9YLq3b.js";import"./useSigner-DJmUz3Zj.js";import"./useTransactionModal-CNIS_SJs.js";import"./ErrorTips-BhsTIZJH.js";import"./HTextLabelBox-BY70NLL6.js";import"./NoData-CAtfmEWj.js";import"./index-D6zwZxJq.js";import"./Loading-Dsp0Ui2A.js";import"./FreshProgressV2-bhvnRYM9.js";import"./index-1JHiME98.js";import"./en_US-Y4ZOVFV4-CvERxhlD.js";import"./index.es-B3i6acCN.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(n){return ge(p,()=>n(p))},subscribeKey(n,e){return fe(p,n,e)},showTooltip({message:n,triggerRect:e,variant:t}){p.open=!0,p.message=n,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
...
`;var Te=function(n,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,o);else for(var c=n.length-1;c>=0;c--)(s=n[c])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i};let J=class extends f{render(){return a`<slot></slot>`}};J.styles=[P,$e];J=Te([u("wui-card")],J);const Ae=v`
  :host {
    display: flex;
    align-items: center;
...
`;var T=function(n,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,o);else for(var c=n.length-1;c>=0;c--)(s=n[c])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i};let b=class extends f{constructor(){super(...arguments),this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="checkmark",this.message="",this.loading=!1,this.iconType="default"}render(){return a`
      ${this.templateIcon()}
