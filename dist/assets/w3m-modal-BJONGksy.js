import{fx as v,fy as f,dn as a}from"./index-DKyrDTV2.js";import{n as w,r as d,o as q}from"./class-map-C7CGp9Wf.js";import{w as ve,u as fe,t as ge,r as be,M as g,S as se,R as l,s as P,a as K,p as ce,n as le,C as m,d as Y,c as ye,h as S,E as ie,O as E,f as F,A as oe,l as T,b as H,T as xe,q as Ce,k as ke,i as Se}from"./core-Ba0PKsWQ.js";import{c as u,U as We}from"./index-Bg_-LpSv.js";import"./vendor-1PTJj1Hr.js";import"./cross-CGxz-MpC.js";import"./index.es-CHkmWRc9.js";import"./async-directive-CO9vbqZq.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return ge(p,()=>r(p))},subscribeKey(r,e){return fe(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
