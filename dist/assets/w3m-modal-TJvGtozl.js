import{G as ve,B as fe,z as ge,x as be,M as g,S as re,R as l,u as v,y as P,v as f,p as a,b as K,s as ce,q as le,C as m,e as Y,d as ye,i as S,m as ie,O as E,g as q,a as oe,n as A,c as H,T as xe,w as Ce,l as ke,j as Se}from"./core-ZrtopM5D.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-C-TaQjKg.js";import"./cross-C5WSy8hd.js";import"./vendor-B9PZvovN.js";import"./index-BAX3pntP.js";import"./index.es-W7yHVXcX.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(s){return ge(p,()=>s(p))},subscribeKey(s,e){return fe(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await re.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
