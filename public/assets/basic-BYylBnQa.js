...
`;var He=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let ge=class extends T{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=L.state.connectors,this.recommended=P.state.recommended,this.featured=P.state.featured,this.unsubscribe.push(L.subscribeKey("connectors",e=>this.connectors=e),P.subscribeKey("recommended",e=>this.recommended=e),P.subscribeKey("featured",e=>this.featured=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return c`
    ...
    `}connectorListTemplate(){const e=ke.getConnectorsByType(this.connectors,this.recommended,this.featured),{custom:i,recent:o,announced:r,injected:n,multiChain:s,recommended:a,featured:l,external:u}=e;return ke.getConnectorTypeOrder({custom:i,recent:o,announced:r,injected:n,multiChain:s,recommended:a,featured:l,external:u}).map(W=>{switch(W){case"injected":return c`
          ...
          ></w3m-connect-external-widget>`;case"recommended":return c`<w3m-connect-recommended-widget
            .wallets=${a}
            tabIdx=${E(this.tabIdx)}
          ></w3m-connect-recommended-widget>`;default:return console.warn(`Unknown connector type: ${W}`),null}})}};ge.styles=Jn;He([d()],ge.prototype,"tabIdx",void 0);He([y()],ge.prototype,"connectors",void 0);He([y()],ge.prototype,"recommended",void 0);He([y()],ge.prototype,"featured",void 0);ge=He([R("w3m-connector-list")],ge);const Qn=k`
  :host {
    flex: 1;
    height: 100%;
  }
...
`;return typeof o=="function"&&o(null,$),$};const Qi=ci,zt=xn,Dn=kn,Yi=Nn;function Yt(t,e,i,o,r){const n=[].slice.call(arguments,1),s=n.length,a=typeof n[s-1]=="function";if(!a&&!Qi())throw new Error("Callback required as last argument");if(a){if(s<2)throw new Error("Too few arguments provided");s===2?(r=i,i=e,e=o=void 0):s===3&&(e.getContext&&typeof r>"u"?(r=o,o=void 0):(r=o,o=i,i=e,e=void 0))}else{if(s<1)throw new Error("Too few arguments provided");return s===1?(i=e,e=o=void 0):s===2&&!e.getContext&&(o=i,i=e,e=void 0),new Promise(function(l,u){try{const h=zt.create(i,o);l(t(h,e,o))}catch(h){u(h)}})}try{const l=zt.create(i,o);r(null,t(l,e,o))}catch(l){r(l)}}Je.create=zt.create;Je.toCanvas=Yt.bind(null,Dn.render);Je.toDataURL=Yt.bind(null,Dn.renderToDataURL);Je.toString=Yt.bind(null,function(t,e,i){return Yi.render(t,i)});const Xi=.1,un=2.5,te=7;function Bt(t,e,i){return t===e?!1:(t-e<0?e-t:t-e)<=i+Xi}function Zi(t,e){const i=Array.prototype.slice.call(Je.create(t,{errorCorrectionLevel:e}).modules.data,0),o=Math.sqrt(i.length);return i.reduce((r,n,s)=>(s%o===0?r.push([n]):r[r.length-1].push(n))&&r,[])}const eo={generate({uri:t,size:e,logoSize:i,padding:o=8,dotColor:r="var(--apkt-tokens-theme-textInvert)"}){const s=[],a=Zi(t,"Q"),l=(e-2*o)/a.length,u=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];u.forEach(({x:w,y:C})=>{const g=(a.length-te)*l*w+o,p=(a.length-te)*l*C+o,m=.45;for(let f=0;f<u.length;f+=1){const _=l*(te-f*2);s.push(Le`
            <rect
...
`;var fe=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let Y=class extends T{constructor(){super(...arguments),this.uri="",this.size=0,this.theme="dark",this.imageSrc=void 0,this.alt=void 0,this.arenaClear=void 0,this.farcaster=void 0}render(){return this.dataset.theme=this.theme,this.dataset.clear=String(this.arenaClear),this.style.cssText=`--local-size: ${this.size}px`,c`<wui-flex
    ...
    `}templateVisual(){return this.imageSrc?c`<wui-image src=${this.imageSrc} alt=${this.alt??"logo"}></wui-image>`:this.farcaster?c`<wui-icon
        ...
        color="inherit"
        name="farcaster"
      ></wui-icon>`:c`<wui-icon size="inherit" color="inherit" name="walletConnect"></wui-icon>`}};Y.styles=[U,to];fe([d()],Y.prototype,"uri",void 0);fe([d({type:Number})],Y.prototype,"size",void 0);fe([d()],Y.prototype,"theme",void 0);fe([d()],Y.prototype,"imageSrc",void 0);fe([d()],Y.prototype,"alt",void 0);fe([d({type:Boolean})],Y.prototype,"arenaClear",void 0);fe([d({type:Boolean})],Y.prototype,"farcaster",void 0);Y=fe([R("wui-qr-code")],Y);const no=k`
  :host {
    display: block;
...
`;var Ye=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let ye=class extends T{constructor(){super(...arguments),this.width="",this.height="",this.variant="default",this.rounded=!1}render(){return this.style.cssText=`
      width: ${this.width};
      height: ${this.height};
    `,this.dataset.rounded=this.rounded?"true":"false",c`<slot></slot>`}};ye.styles=[no];Ye([d()],ye.prototype,"width",void 0);Ye([d()],ye.prototype,"height",void 0);Ye([d()],ye.prototype,"variant",void 0);Ye([d({type:Boolean})],ye.prototype,"rounded",void 0);ye=Ye([R("wui-shimmer")],ye);const io=k`
  wui-shimmer {
    width: 100%;
    aspect-ratio: 1 / 1;
    border-radius: ${({borderRadius:t})=>t[4]};
